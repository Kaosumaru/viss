...
export const SelectionAreaDemo: React.FC = () => {
  ...
  const [lastCompletedSelection, setLastCompletedSelection] = useState<SelectionRect | null>(null);
  ...
  const formatRect = (rect: SelectionRect | null) => {
    ...
    return `x: ${left.toFixed(0)}, y: ${top.toFixed(0)}, w: ${width.toFixed(0)}, h: ${height.toFixed(0)}`;
  };
    ...
    <Box sx={{ p: 3, minHeight: "100vh", backgroundColor: "#1e1e1e" }}>
      ...
      <Paper sx={{ p: 2, mb: 3, backgroundColor: "#2d2d30", color: "#ffffff" }}>
        ...
        <Typography variant="body2" sx={{ mb: 1 }}>
          • Hold down the middle mouse button and drag to create a selection area
        </Typography>
        <Typography variant="body2" sx={{ mb: 1 }}>
      ...
      >
        <Box sx={{ p: 3, height: "100%" }}>
          ...
          <Typography variant="body2" sx={{ color: "#cccccc", mb: 2 }}>
            This is the content inside the selection area. You can middle-click and drag to select regions.
          </Typography>
